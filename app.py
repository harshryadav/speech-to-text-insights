...
#     st.sidebar.markdown("---")
#     with st.sidebar.expander("BART / T5 need Hugging Face"):
#         st.caption(
#             "These models download from **huggingface.co** the first time they run. "
#             "Some work **VPNs block** that site—use TextRank only, try off VPN, "
#             "or download models on another network (see README)."
#         )
...
#     if "t5" in methods:
#         with st.spinner("Loading T5 and summarizing..."):
#             summarizer = try_load_hf_summarizer("t5-base")
#             if summarizer is None:
#                 hf_skipped.append("T5 (`t5-base`)")
#             else:
#                 t0 = time.perf_counter()
...
#         with col:
#             label = {"textrank": "TextRank (Extractive)", "bart": "BART (Abstractive)", "t5": "T5 (Abstractive)"}
